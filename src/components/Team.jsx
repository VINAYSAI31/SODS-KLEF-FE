...
const Team = () => {
  ...
  const allTeamMembers = [
    ...
    },
    {
      name: 'Vinay Sai',
      role: 'Mentor',
      bio: 'Vinay is a mentor, providing guidance and advice to the  members of the club in projects.',
    ...
    },
    {
      name: 'Alex Thompson',
      role: 'Technical Lead',
      bio: 'Alex is a passionate technical lead with expertise in system architecture and software development.',
    ...
    },
    {
      ...
      bio: 'David leads the non-technical side of the club, ensuring smooth operations and management.',
    ...
    },
    {
      name: 'Eve Johnson',
      role: 'Secretary',
      bio: 'Eve is responsible for managing all administrative tasks and keeping records of meetings and events.',
    ...
    },
    {
      name: 'Olivia Brown',
      role: 'Project Lead',
      bio: 'Olivia oversees all projects, ensuring timely execution and delivering high-quality results.',
    ...
    },
    {
      name: 'Liam Wilson',
      role: 'Drafting Lead',
      bio: 'Liam is in charge of drafting documentation and ensuring that all content is clear and concise.',
    ...
    },
    {
      ...
      bio: 'Charlotte leads the content writing team, ensuring that all written materials are well-crafted and impactful.',
    ...
    
    {
      name: 'David Kumar',
      role: 'Research Lead',
      bio: 'David leads the research initiatives, focusing on data analysis and machine learning algorithms.',
      image: '',
