...
const Team = () => {
  ...
  const allTeamMembers = [
    ...
    // y23 club members
    {
      name: 'S SIVA PRASANNA ',
      role: 'Club Member',
      bio:'Prasanna actively contributes to club activities, collaborating on research projects and assisting in organizing workshops on data science and machine learning',
      image: './images/second8.jpg',
    ...
    },
    {
      name: 'bandaru Charan',
      role: 'Club Member',
      bio:'Charan supports the club by working on hands-on coding challenges and helping members with technical issues.',
      image: './images/second2.jpg',
      linkedin: 'https://linkedin.com/in/david-kumar',
      email: 'david@datasciclub.edu',
      github: 'https://github.com/david-kumar',
      year: 'y23',
    },
    {
      name: 'Tarun shiva',
      role: 'Club Member',
      bio: 'Tarun collaborates on research tasks and assists in organizing interactive sessions for skill-building',
      image: './images/second4.jpg',
      linkedin: 'https://linkedin.com/in/david-kumar',
      email: 'david@datasciclub.edu',
      github: 'https://github.com/david-kumar',
      year: 'y23',
    },
    {
      name: 'Hemavardhan',
      role: 'Club Member',
      bio: 'Hemavardhan focuses on sharing knowledge and contributing to discussions on emerging trends in machine learning',
      image: './images/second5.jpg',
      linkedin: 'https://linkedin.com/in/david-kumar',
      email: 'david@datasciclub.edu',
      github: 'https://github.com/david-kumar',
      year: 'y23',
    },
    {
      name: 'Rohith ',
      role: 'Club Member',
      bio: 'Rohith is committed to helping the team analyze data and explore innovative machine learning algorithms',
      image: './images/second6.jpg',
      linkedin: 'https://linkedin.com/in/david-kumar',
      email: 'david@datasciclub.edu',
      github: 'https://github.com/david-kumar',
      year: 'y23',
    },
    {
      name: 'Bhagya Sri',
      role: 'Club Member',
      bio: 'Bhagya Sri  actively supports research efforts, contributing to project documentation and team coordination.',
      image:'./images/second7.jpg',
      linkedin: 'https://linkedin.com/in/david-kumar',
      email: 'david@datasciclub.edu',
      github: 'https://github.com/david-kumar',
      year: 'y23',
